...
# bedzie trzeba to podzielic na residues

#####################################################################################################################################################
#####################################################################################################################################################
#####################################################################################################################################################
# co moze byc podmiotem tego? na pewno PDB File Contents
...
def calculate_asa(atoms, probe, n_sphere_point=960):
    ...
    for i, atom_i in enumerate(atoms):
        ...
        areas.append(area)
    return areas # ok a wiec to moze byc to
...
def main():
  ...
  mol = molecule.Molecule(args[0]) # robi to z pliku PDB
  atoms = mol.atoms() # tak robi atomy z tego
